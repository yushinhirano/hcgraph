...
require 'lib/html/header/graph_view_header_builder'
require 'lib/html/body/graph_view_body_builder'
...
#@autor tohirano
#
class GraphViewHtmlBuilder < HtmlBuilder
  ...
  def buildHeader(all_view_config)
    header_builder = GraphViewHeaderBuilder.new
  ...
  def buildBody(all_view_config)
    body_builder = GraphViewBodyBuilder.new
